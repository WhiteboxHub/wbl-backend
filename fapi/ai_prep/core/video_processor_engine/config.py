"""
Video Processor Engine Configuration
====================================
...
SUPPORTED_AUDIO_FORMATS: List[str] = ["wav", "ogg", "mp3", "webm"]
...
MIN_ASSEMBLED_VIDEO_BYTES: int = int(
    os.getenv("AIPREP_MIN_ASSEMBLED_VIDEO_BYTES", "100" if os.getenv("ENV") == "test" else "512")
)
MIN_AUDIO_FILE_BYTES: int = int(
    os.getenv("AIPREP_MIN_AUDIO_FILE_BYTES", "44" if os.getenv("ENV") == "test" else "256")
)
