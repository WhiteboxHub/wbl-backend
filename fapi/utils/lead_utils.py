...
#             or_(
#                 LeadORM.full_name.ilike(search_pattern),
#                 LeadORM.email.ilike(search_pattern),
#                 LeadORM.phone.ilike(search_pattern),
#                 LeadORM.status.ilike(search_pattern),
#                 LeadORM.workstatus.ilike(search_pattern),
#                 LeadORM.address.ilike(search_pattern),
#             )
#         )
...
#     return {"total": total, "page": page, "limit": limit, "data": leads_data}
...
# ):
#     return fetch_all_leads_paginated(db, page, limit, search)
...
#         search_pattern = f"%{search}%"
#         if search_by == "name":
#             query =query.filter(LeadORM.full_name.ilike(search_pattern))
#         elif search_by == "email":
#             query=query.filter(LeadORM.email.ilike(search_pattern))
#         elif search_by == "phone":
#             query=query.filter(LeadORM.phone.ilike(search_pattern))
