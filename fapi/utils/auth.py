...
# # from fapi.auth import verify_password
# from fapi.utils.auth_utils import verify_password
...
# async def authenticate_user(db: Session, uname: str, passwd: str):
#     user = get_user_by_username(db, uname)
#     if not user or not verify_password(passwd, user.passwd):
#         return None
