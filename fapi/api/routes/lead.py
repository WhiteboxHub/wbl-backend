...
@router.get("/lead", summary="Get all leads (paginated)")
...
@router.post("/lead", response_model=LeadSchema)
...
@router.post("/lead/movetocandidate/{lead_id}")
...
@router.delete("/lead/movetocandidate/{lead_id}")
