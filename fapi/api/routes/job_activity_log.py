...
def get_all_job_activity_logs(
    ...
    return job_activity_log_utils.get_all_job_activity_logs(db)
...
def get_job_activity_log(
    ...
    return job_activity_log_utils.get_job_activity_log_by_id(db, log_id)
...
def get_logs_by_job(
    ...
    return job_activity_log_utils.get_logs_by_job_id(db, job_id)
...
def get_logs_by_employee(
    ...
    return job_activity_log_utils.get_logs_by_employee_id(db, employee_id)
...
def create_job_activity_log(
    ...
    return job_activity_log_utils.create_job_activity_log(db, log_data)
...
def update_job_activity_log(
    ...
    return job_activity_log_utils.update_job_activity_log(db, log_id, update_data)
...
def delete_job_activity_log(
    ...
    return job_activity_log_utils.delete_job_activity_log(db, log_id)
...
def get_all_job_types(
    ...
    """Get all job types"""
    return job_activity_log_utils.get_all_job_types(db)
...
def delete_job_type(
    ...
    """Delete job type"""
    return job_activity_log_utils.delete_job_type(db, job_type_id)