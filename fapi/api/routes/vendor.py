...
def update_vendor_route(vendor_id: int, update_data: VendorUpdate, db: Session = Depends(get_db)):
    print(" Update schema received:", update_data.dict(exclude_unset=True))
